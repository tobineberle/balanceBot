...
#define STABILIZE_TIME		1
#define MIN_PULSE_LENGTH	5	//[us], note 1us min pulse length minimum, we give 10 for margin
#define MAX_RPM				140

enum Direction {FORWARD, BACKWARD};
enum State {IDLE, RUNNING, SLEEPING, STABILIZING};
enum Mode {CONSTANT_SPEED, LINEAR_SPEED, CONTINUOUS_SPEED, STEP_QUEUE};
...
struct A4988
{
	...
	int16_t _sps;						//Motor speed in steps/s
	...
	volatile int32_t _position;		//Current position cumulative
...
int16_t A4988_getAngleDeg(A4988_t* motor);
